{ lib, stdenv, fetchurl, fetchzip, lua, jemalloc, pkg-config, nixosTests
...
stdenv.mkDerivation (finalAttrs: {
  pname = "redict";
  version = "7.2.4-unstable";

  src = fetchzip {
    url = "https://codeberg.org/redict/redict/archive/87e1e608cc74504d2dee0d0139d5c5f4a9ab8966.tar.gz";
    hash = "sha256-FnPS244BUqYXzKtcavEHOCBPIM9GXj1y1A6vOFUl7oo=";
  };
  ...
  meta = with lib; {
    ...
    description = "A distributed key/value store (a remote dictionary, if you will).";
